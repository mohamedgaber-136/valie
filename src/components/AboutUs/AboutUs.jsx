...
export const AboutUs = ({ right }) => {
  ...
  return (
    <div
      className="container position-relative d-flex flex-column gap-3 my-50"
      id="about"
      ...
      <div className="row align-items-center">
        <div className="col-md-6 col-12 d-flex flex-column gap-2">
          <div className="d-flex align-items-center gap-2 mb-2">
            <h3 className="fw-lighter mainText">{t("aboutSection.about")}</h3>
            <img src={goldLogo} alt="" width="100px" />
          </div>

          <h3 className="fw-bold mainColor">{t("aboutSection.line1")}</h3>
          ...
          >
            <h6 className="fw-normal mainColor">{t("aboutSection.readMore")}</h6>
          </Link>
        </div>
        ...
        <div className="col-md-6 position-relative d-flex justify-content-center col-12">
          <div className="imgParent bg-white wow fadeInUp">
            <img
              src={aboutImg}
              alt=""
              className={`${isArabic ? "ms-3" : "me-3"} mt-3  wow fadeInUp`}
            />
          </div>
