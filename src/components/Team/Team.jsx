    ...
    <div className=" teamContainer" id="team">
      ...
      <div className="row p-0 gap-5 gap-md-0  DataContainer">
        {data.map((item, index) => (
          <div
            className={`${
              item.float ? "floatCard " : ""
            }  wow fadeInUp col-12 d-flex flex-column align-items-center justify-content-center col-md-4 `}
            key={index}
          >
            ...
            <div className="d-flex align-items-center justify-content-center flex-column gap-2 dataContent">
              <h2 className="AgentName  CustomFont text-center">{item.name}</h2>
              <h4 className="AgentTitle CustomFont  text-center">{item.title}</h4>
              <h6 className="Agentexp  CustomFont text-center">{item.experience}</h6>
            </div>
            <h6 className="Agentexp foot CustomFont text-center">{item.agent}</h6>
          </div>
        ))}
      </div>
    </div>
