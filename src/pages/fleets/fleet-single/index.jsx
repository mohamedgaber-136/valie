...
export default function FleetSinglePage() {
  ...
  const {data,isSuccess,isLoading} = useGetItemsQuery(`vehicle/${params.id}`)
  return (
    <>
      ...
      <main className="main">
       ...
       {isLoading?<div className="loaderParent">
        ...
        <Details car={isSuccess&&data.data} />
        <Features car={isSuccess&&data.data} />
        <BookSection car={isSuccess&&data.data} />
        </>}
